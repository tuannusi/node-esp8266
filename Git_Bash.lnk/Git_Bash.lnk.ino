...
const char* ssid = "Van Tri";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "01223678660";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "192.168.1.47";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
